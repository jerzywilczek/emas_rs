...
impl<const N: usize, F: FitnessFn<N>, CF: CombatWinChanceFn, RF: ReproductionChanceFn> Island<N, F, CF, RF> {
...
#[derive(Debug)]
pub struct System<const N: usize, F: FitnessFn<N>, CF: CombatWinChanceFn, RF: ReproductionChanceFn> {
...
impl<const N: usize, F: FitnessFn<N>, CF: CombatWinChanceFn, RF: ReproductionChanceFn> System<N, F, CF, RF> {
...
impl<const N: usize, F: FitnessFn<N>, CF: CombatWinChanceFn, RF: ReproductionChanceFn> SystemBuilder<N, F, CF, RF> {
    pub fn new() -> Self {
        SystemBuilder {
            island_amount: 5,
